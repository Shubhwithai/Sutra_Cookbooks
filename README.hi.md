...
SUTRA निम्नलिखित के लिए स्केलेबल AI अनुप्रयोगों को शक्ति प्रदान करता है:
- वार्तालाप
- खोज
- उन्नत तर्क

यह विविध भाषाओं, डोमेन और अनुप्रयोगों में उच्च प्रदर्शन सुनिश्चित करता है।

## इस कुकबुक में आपको क्या मिलेगा

| अनुभाग | विवरण |
|---------|-------------|
| **आरंभ करना** | परिचयात्मक ट्यूटोरियल, बुनियादी उपयोग पैटर्न, और सेटअप गाइड |
| **बहुभाषी उदाहरण** | 50+ भाषाओं में SUTRA की क्षमताओं को प्रदर्शित करने वाले कोड नमूने |
| **एकीकरण गाइड** | लोकप्रिय फ्रेमवर्क और टूल के साथ SUTRA को एकीकृत करने के लिए निर्देश |
| **RAG कार्यान्वयन** | ज्ञान-गहन कार्यों के लिए पुनर्प्राप्ति-संवर्धित जनरेशन उदाहरण |
...
यह रिपॉजिटरी निम्नलिखित अनुभागों में व्यवस्थित है:

1. **getting-started** - सूत्र के साथ आरंभ करने में आपकी सहायता के लिए परिचयात्मक सामग्री और उदाहरण
2. **integrations** - सूत्र को अन्य उपकरणों और सेवाओं के साथ एकीकृत करने के लिए उदाहरण और मार्गदर्शिकाएँ
3. **starter-apps** - सूत्र के साथ निर्मित उपयोग के लिए तैयार स्टार्टर एप्लिकेशन
4. **agents** - सूत्र का उपयोग करके एजेंट बनाने और तैनात करने के लिए उदाहरण और ट्यूटोरियल
5. **usecases** - विभिन्न उद्योगों में वास्तविक दुनिया के उपयोग मामलों का कार्यान्वयन
6. **rag** - पुनर्प्राप्ति-संवर्धित जनरेशन (RAG) को लागू करने के लिए उदाहरण और सर्वोत्तम प्रथाएँ
7. **images** - दस्तावेज़ीकरण में उपयोग की जाने वाली छवियाँ

प्रत्येक निर्देशिका में अधिक विस्तृत जानकारी के साथ अपना स्वयं का README है।
